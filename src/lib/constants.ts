 ...
 */
export const APP_NAME: string = 'BasePlace';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Every 6 hours a community canvas resets on Base network — draw, collaborate, mint the final piece as an NFT.';
 ...
 */
export const APP_TAGS: string[] = ['rplace', 'base', 'game'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Drop Pixel';
